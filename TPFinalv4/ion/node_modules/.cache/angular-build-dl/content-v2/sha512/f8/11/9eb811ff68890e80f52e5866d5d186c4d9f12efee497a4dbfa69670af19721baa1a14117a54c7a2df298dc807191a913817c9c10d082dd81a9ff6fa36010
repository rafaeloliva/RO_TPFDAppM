...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | detalle-sensor-detalle-sensor-module */[__webpack_require__.e("common"), __webpack_require__.e("detalle-sensor-detalle-sensor-module")]).then(__webpack_require__.bind(null, /*! ./detalle-sensor/detalle-sensor.module */ "./src/app/detalle-sensor/detalle-sensor.module.ts")).then(m => m.DetalleSensorPageModule)
    },
    {
        path: 'log-sensor/:id',
        loadChildren: () => Promise.all(/*! import() | log-sensor-log-sensor-module */[__webpack_require__.e("common"), __webpack_require__.e("log-sensor-log-sensor-module")]).then(__webpack_require__.bind(null, /*! ./log-sensor/log-sensor.module */ "./src/app/log-sensor/log-sensor.module.ts")).then(m => m.LogSensorPageModule)
    },
    {
        path: 'log-ev/:id',
        loadChildren: () => Promise.all(/*! import() | log-ev-log-ev-module */[__webpack_require__.e("common"), __webpack_require__.e("log-ev-log-ev-module")]).then(__webpack_require__.bind(null, /*! ./log-ev/log-ev.module */ "./src/app/log-ev/log-ev.module.ts")).then(m => m.LogEvPageModule)
    },
    {
        path: 'about',
...
module.exports = __webpack_require__(/*! /home/rafael/MIoT2020/DAppM/TPFinalDAM2RO/TPFDAppM4RO/ion/src/main.ts */"./src/main.ts");
